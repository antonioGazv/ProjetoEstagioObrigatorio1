...
<body>
    ...
    <div class="main-header">
        <h1>Criar Unidade Curricular</h1>
    ...
    <div class="container-edit-create">
        <form action="{{ route('UCStore') }}" method="POST" class="form-edit-create">
            @csrf
            <label for="">Nome da UC</label>
            <input type="text" name="NomeUC" class="inp-create-user" autocomplete="off">
            ...
            <input type="number" name="CargaHoraria" class="inp-create-user">
            <label for="">Quantidade de Alunos</label>
            <input type="number" name="qtdAlunos" class="inp-create-user">
