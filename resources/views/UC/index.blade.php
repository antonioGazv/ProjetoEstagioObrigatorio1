...
<body>
            ...
            <tbody>
                @foreach ($UCs as $UC)
                    <tr class="tr-data">
                        ...
                        <td><a class='btn btn-primary' href="{{ route('UCEdit', ['id' => $UC->idUC]) }}">
                        ...
                        <td>
                            <form action="{{ route('UCDestroy', ['id' => $UC->idUC]) }}" method="POST">
                                @csrf
                                @method('delete')
    ...
    <div>
        <a href="{{ route('UCCreate') }}">
            <button id="bt-create">Criar</button>
        </a>
    </div>

    <div class="back-to-menu">
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-home back-menu" width="44" height="44" id="back-menu-test"
