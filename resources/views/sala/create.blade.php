...
<body>
    ...
    <div class="container-edit-create">
        <form action="{{ route('salaStore') }}" method="POST" class="form-edit-create">
            @csrf
            <label for="">Nome da Sala</label>
            <input type="text" name="NomeSala" class="inp-create-user" autocomplete="off">
            <label for="">Capacidade</label>
            <input type="text" name="Capacidade" class="inp-create-user" autocomplete="off">
            <label for="">Categoria</label>
            <input type="number" name="Categoria" class="inp-create-user">
